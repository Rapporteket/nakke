#Resultattjeneste for Degenerativ Nakke
...
ui_nakke <- function() {
 ...
 # addResourcePath('rap', system.file('www', package='rapbase'))
  ...
  inngrepValg <- c('Alle'=99,
                   'Ikke klassifiserbar operasjon'=0,
                   'Fremre diketomi for prolaps'=1,
                   'Bakre dekompresjon'=2,
                   'Fremre dekompresjon sp st.uten prolaps'=3,
                   'Bakre fusjon'=4,
                   'Korporektomi'=5,
                   'Andre inngrep'=6)
...
server_nakke <- function(input, output, session) {
  ...
  #----------- Eksport ----------------
  ## brukerkontroller
  rapbase::exportUCServer("nakkeExport", "nakke")
  ## veileding
