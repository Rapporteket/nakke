...
dum <- FigAndelerGrVar(RegData=RegData, preprosess=0, #datoFra = '2016-01-01',
                              valgtVar='Alder', outfile='NakkeAlder70.pdf')
dum <- FigAndelTid(RegData=RegData, preprosess=0, valgtVar='Alder', outfile='NakkeAlder70Tid.pdf')

#Myelopati
dum <- FigAndelerGrVar(RegData=RegData, preprosess=0, #datoFra = '2016-01-01',
                              valgtVar='OprIndikMyelopati', outfile='NakkeMyelopatiSh.pdf')
dum <- FigAndelTid(RegData=RegData, preprosess=0,
                              valgtVar='OprIndikMyelopati', outfile='NakkeMyelopatiTid.pdf')

#Nytte
dum <- FigAndelerGrVar(RegData=RegData, preprosess=0, datoTil='2015-12-31', #datoFra = '2014-01-01',
                       valgtVar='NytteOpr12mnd', outfile='NakkeNytteOpr12mndSh.pdf')
dum <- FigAndelTid(RegData=RegData, preprosess=0, datoTil='2015-12-31',
                      valgtVar='NytteOpr12mnd', outfile='NakkeNytteOpr12mndTid.pdf')

#Stemmevansker3mnd, fremre, uten myelopati
dum <- FigAndelerGrVar(RegData=RegData, preprosess=0, valgtVar='KomplStemme3mnd', #datoFra = '2015-01-01',
                                     myelopati=1,fremBak = 1, outfile='NakkeStemme3mndSh.pdf')
dum <- FigAndelTid(RegData=RegData, preprosess=0, valgtVar='KomplStemme3mnd',
                                     myelopati=1,fremBak = 1, outfile='NakkeStemme3mndTid.pdf')

#Svelgvansker3mnd, fremre, uten myelopati
dum <- FigAndelerGrVar(RegData=RegData, preprosess=0, valgtVar='KomplSvelging3mnd', #datoFra = '2015-01-01',
                                     myelopati=1,fremBak = 1, outfile='NakkeSvelg3mndSh.pdf')
dum <- FigAndelTid(RegData=RegData, preprosess=0, valgtVar='KomplSvelging3mnd',
                                     myelopati=1,fremBak = 1, outfile='NakkeSvelg3mndTid.pdf')


#Bruk av antibiotikaprofylakse (fremre, bakre)
dum <- FigAndelerGrVar(RegData=RegData, preprosess=0, valgtVar='Antibiotika', #datoFra = '2015-01-01',
                                     fremBak = 1, outfile='NakkeAntibiotikaFremSh.pdf')
dum <- FigAndelTid(RegData=RegData, preprosess=0,  valgtVar='Antibiotika',
...
dum <- FigAndelerGrVar(RegData=RegData, preprosess=0, valgtVar='Saardren', #datoFra = '2015-01-01',
                                     myelopati=0,fremBak = 1, outfile='NakkeSaardrenUmFSh.pdf')
dum <- FigAndelTid(RegData=RegData, preprosess=0, valgtVar='Saardren',
                                     myelopati=0,fremBak = 1, outfile='NakkeSaardrenUmFTid.pdf')

#Sårinfeksjon, 3mnd, kun bakre kirurgi
#RIKTIG VARIABEL??
dum <- FigAndelerGrVar(RegData=RegData, preprosess=0, valgtVar='KomplinfekOverfl3mnd', #datoFra = '2015-01-01',
                                     fremBak = 2, outfile='NakkeKomplinfekOverfl3mndSh.pdf')
dum <- FigAndelTid(RegData=RegData, preprosess=0, valgtVar='KomplinfekOverfl3mnd',
...
dum <- FigAndelerGrVar(RegData=RegData, preprosess=0, valgtVar='NRSsmerteArmEndr12mnd', #datoFra = '2015-01-01',
                                     myelopati=0, fremBak = 1, outfile='NakkeNRSsmerteArmEndr12mndUmFSh.pdf')
#dum <- FigAndelTid(RegData=RegData, preprosess=0, valgtVar='NRSsmerteArmEndr12mnd',
...
dum <- FigAndelTid(RegData=RegData, preprosess=0, datoTil='2015-12-31', valgtVar='FornoydBeh12mnd',
