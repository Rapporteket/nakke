...
print(paste0('Finnes RegData? ',!exists('RegData')))
if (!exists('SkjemaData')){
      RegData <- NakkeRegDataSQL(datoFra = '2017-01-01') #datoFra = datoFra, datoTil = datoTil)

  querySD <- paste0('SELECT
...
if (server == 0){
  dato <- '2018-03-02'
  SkjemaData <- read.table('A:/Nakke/SkjemaOversikt2018-03-02.csv', sep=';', header=T, encoding = 'UTF-8')
...
dum <- NakkeFigAndelerGrVar(RegData=RegData12mnd, preprosess=FALSE, valgtVar='KomplinfekOverfl3mnd', datoFra = datoFra,
                                     outfile='NakkeKomplinfekOverfl3mndSh.pdf')
dum <- NakkeFigAndelTid(RegData=RegData, preprosess=FALSE, valgtVar='KomplinfekOverfl3mnd', datoFra = datoFra,
...
dum <- NakkeFigAndelerGrVar(RegData=RegData12mnd, preprosess=FALSE, valgtVar='Komplinfek', datoFra = datoFra,
                                     Ngrense = 10, outfile='NakkeKomplinfek3mndSh.pdf')
#EnhverKompl3mnd
#Andel fornøyde med behandlinga
dum <- NakkeFigAndelerGrVar(RegData=RegData12mnd, preprosess=FALSE, datoFra = datoFra,
