...
dum <- NakkeFigAndelTid(RegData=RegData, preprosess=FALSE, valgtVar='KomplStemme3mnd', datoFra = datoFra,
...
dum <- NakkeFigAndelTid(RegData=RegData, preprosess=FALSE, valgtVar='KomplSvelging3mnd', datoFra = datoFra,
                        myelopati=0, enhetsUtvalg = 1, reshID = reshID, tidsenhet = 'Mnd',
                        outfile='KomplSvelging3mndTid.pdf')
...
dum <- NakkeFigAndelTid(RegData=RegData, preprosess=FALSE, valgtVar='Saardren', datoFra = datoFra,
...
dum <- NakkeFigAndelTid(RegData=RegData, preprosess=FALSE, valgtVar='Komplinfek',
                        fremBak = 2, enhetsUtvalg = 1, reshID = reshID, tidsenhet = 'Mnd',
                        outfile='NakkeKomplinfekOverfl3mndTid.pdf')
#EnhverKompl3mnd
...
dum <- NakkeFigAndelTid(RegData=RegData, preprosess=FALSE, valgtVar='NytteOpr3mnd',
                        ...
                        outfile='NakkeNytteOpr3mndFrenUmTid.pdf')
...
NakkeFigGjsnTid(RegData=RegData12mnd, preprosess=FALSE, valgtVar='NDIendr3mnd',
           fremBak=1, myelopati=0,
           reshID=reshID, enhetsUtvalg=enhetsUtvalg, outfile='NDIendr3mndFremUmSh.pdf')
...
NakkeFigGjsnTid(RegData=RegData12mnd, preprosess=FALSE, valgtVar='NDIendr3mnd',
           fremBak=2, myelopati=1,
           reshID=reshID, enhetsUtvalg=enhetsUtvalg, outfile='NDIendr3mndBakMmSh.pdf')
...
NakkeFigGjsnTid(RegData=RegData12mnd, preprosess=FALSE, valgtVar='NRSsmerteArmEndr3mnd',
           fremBak=2, myelopati=1,
           reshID=reshID, enhetsUtvalg=enhetsUtvalg, outfile='NRSsmerteArmEndr3mndBakMmSh.pdf')
...
\begin{figure}[ht]
\centering
\includegraphics[scale=0.35]{NakkeFornoydBeh3mndFremUmTid.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[scale=0.35]{NakkeFornoydBeh3mndBakMmTid.pdf}
\caption{Pasienter med myelopati operert med bakre tilgang og som har blitt helt bra eller mye bedre 3 mnd. etter operasjonen.}
\end{figure}
\end{frame}
