...
#Henter data to år tilbake:
datoFra <- as.Date(paste0(1900+dato$year-1-ifelse(dato$mon==11, 0, 1),'-', ifelse(dato$mon==11, 1, dato$mon+1), '-', '01'))
...
#----------------------------------------
datoFra12mnd <- as.Date(paste0(1900+dato$year-ifelse(dato$mon==11, 0, 1),'-', ifelse(dato$mon==11, 1, dato$mon+1), '-', '01'))
RegData <- NakkePreprosess(RegData = RegData)
RegData24mnd <- RegData[RegData$InnDato > as.POSIXlt(datoFra), ]
RegData12mnd <- RegData[RegData$InnDato > as.POSIXlt(datoFra12mnd), ]
AarNaa <- as.numeric(format(Sys.Date(), "%Y"))
# Nye variable:
RegData$Mnd <- RegData$MndNum #RegData$InnDato$mon +1
...
dum <- NakkeFigAndelTid(RegData=RegData24mnd, preprosess=FALSE, valgtVar='KomplStemme3mnd', datoFra = datoFra,
...
dum <- NakkeFigAndelerGrVar(RegData=RegData24mnd, preprosess=FALSE, valgtVar='KomplSvelging3mnd', #datoFra = datoFra,
                            myelopati=0,outfile='NakkeSvelg3mndSh.pdf')
dum <- NakkeFigAndelTid(RegData=RegData24mnd, preprosess=FALSE, valgtVar='KomplSvelging3mnd', datoFra = datoFra,
                        myelopati=0, enhetsUtvalg = 1, reshID = reshID, tidsenhet = tidsenhRapp,
                        outfile='NakkeSvelg3mndTid.pdf')

#Brukav sårdren, fremre, uten myelopati
dum <- NakkeFigAndelerGrVar(RegData=RegData24mnd, preprosess=FALSE, valgtVar='Saardren', datoFra = datoFra,
                            myelopati=0, fremBak = 1, outfile='NakkeSaardrenUmFSh.pdf')
dum <- NakkeFigAndelTid(RegData=RegData24mnd, preprosess=FALSE, valgtVar='Saardren', datoFra = datoFra,
                        myelopati=0,  fremBak = 1, enhetsUtvalg = 1, reshID = reshID, tidsenhet = tidsenhRapp,
...
#dum <- NakkeFigAndelerGrVar(RegData=RegData24mnd, preprosess=FALSE, valgtVar#='Komplinfek',
 #                           outfile='NakkeKomplinfek3mndSh.pdf')
#dum <- NakkeFigAndelTid(RegData=RegData24mnd, preprosess=FALSE, valgtVar='Komplinfek',
...
dum <- NakkeFigAndelTid(RegData=RegData24mnd, preprosess=FALSE, valgtVar='FornoydBeh3mnd',
                        enhetsUtvalg = 1, reshID = reshID, tidsenhet = tidsenhRapp,
...
dum <- NakkeFigAndelTid(RegData=RegData24mnd, preprosess=FALSE, valgtVar='NytteOpr3mnd',
                        fremBak = 1, myelopati=0, enhetsUtvalg = 1, reshID = reshID, tidsenhet = tidsenhRapp,
...
# dum <- NakkeFigAndelTid(RegData=RegData24mnd, preprosess=FALSE, valgtVar='NytteOpr3mnd',
#                          fremBak = 2, myelopati=1, enhetsUtvalg = 1, reshID = reshID, tidsenhet = tidsenhRapp,
...
NakkeFigGjsnTid(RegData=RegData24mnd, preprosess=FALSE, valgtVar='NDIendr3mnd',
...
#
# NakkeFigGjsnTid(RegData=RegData24mnd, preprosess=FALSE, valgtVar='NDIendr3mnd',
#            fremBak=2, myelopati=1, tidsenhet=tidsenhRapp,
...
NakkeFigGjsnTid(RegData=RegData24mnd, preprosess=FALSE, valgtVar='NRSsmerteArmEndr3mnd',
           fremBak=1, myelopati=0, tidsenhet=tidsenhRapp,
...
NakkeFigGjsnTid(RegData=RegData24mnd, preprosess=FALSE, valgtVar='NRSsmerteNakkeEndr3mnd',
